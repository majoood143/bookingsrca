...
return [
    ...
    'sections' => [
        ...
        'attendee_details' => 'بيانات الحضور',
        'pricing'          => 'التسعير',
    ...
    'fields' => [
        ...
        'quantity_description' => 'هذا يحدد عدد نماذج الحضور التي ستظهر أدناه',
    ...
    'tooltips' => [
        'resend_tickets'    => 'إعادة إرسال التذاكر الفردية لجميع الحضور',
    ...
    'notifications' => [
        ...
        'tickets_sent_body'    => 'تم إرسال جميع :count تذكرة/تذاكر إلى الحضور.',
        'tickets_partial'      => 'تم الإرسال جزئيًا',
        'tickets_partial_body' => 'تم إرسال :sent بنجاح، فشل إرسال :failed.',
        'booking_confirmed'    => 'تم تأكيد الحجز',
        'booking_confirmed_body' => 'تم إرسال التذاكر لجميع الحضور.',
        'booking_cancelled'    => 'تم إلغاء الحجز',
        'booking_created'      => 'تم إنشاء الحجز',
        'booking_created_body' => 'تم إرسال التذاكر الفردية لجميع الحضور.',
    ...
    'ticket_type_helper'           => 'اختر نوع التذكرة لهذا الحاضر',
    ...
    'wizard' => [
        ...
        'title'             => 'معالج الحجز',
        'available'         => 'متاح',
        'no_services_note'  => 'لا توجد خدمات إضافية متاحة لهذه الفعالية — يمكنك تخطي هذه الخطوة.',
        'summary_heading'   => 'ملخص الحجز',
        'attendee_names'    => 'الحضور',
        'copy_contact_to_all' => 'تطبيق البريد الإلكتروني والهاتف للحاضر الأول على جميع الحاضرين الآخرين',
        ...
        'success_subheading'=> 'تم إنشاء التذاكر وإرسالها إلى الحضور عبر البريد الإلكتروني.',
        'steps' => [
            'event'               => 'الفعالية والموعد',
            'event_description'   => 'اختر الفعالية والتاريخ والوقت وعدد التذاكر',
            'services'             => 'الخدمات الإضافية',
            'services_description' => 'إضافات اختيارية لهذا الحجز',
            'attendees'            => 'بيانات الحضور',
        ...
        'notifications' => [
            ...
            'created_body'       => 'تم تأكيد الحجز :reference وإرسال التذاكر إلى الحضور.',
        ],
    ],
