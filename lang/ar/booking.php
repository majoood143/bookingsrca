...
return [
    ...
    'tooltips' => [
        ...
        'print_receipt'     => 'وضع إيصال مطبوع حرارياً لهذا الحجز في قائمة الانتظار — سيقوم وكيل الطباعة الموقعي بطباعته قريباً',
        'print_tickets'     => 'وضع تذكرة مطبوعة حرارياً لكل حاضر في قائمة الانتظار — سيقوم وكيل الطباعة الموقعي بطباعتها قريباً',
    ...
    'notifications' => [
        ...
        'tickets_queued'       => 'تم وضع تذاكر الحضور في قائمة الطباعة',
        'tickets_queue_failed' => 'فشل وضع تذاكر الحضور في قائمة الطباعة',
        'receipt_queued'       => 'تم وضع الإيصال في قائمة الطباعة',
        'receipt_queue_failed' => 'فشل وضع الإيصال في قائمة الطباعة',
    ...
    'payments' => [
        ...
        'methods' => [
            ...
            'partial'      => 'دفعة جزئية',
            'thawani'      => 'ثواني (أونلاين)',
            'nbo'          => 'البنك الوطني (أونلاين)',
            'ccavenue'     => 'سي سي أفينيو (أونلاين)',
        ],
        'summary' => [
