...
return [
    ...
    'private' => [
        'heading'               => 'هذه الفعالية خاصة',
        'message'               => 'أدخل كلمة المرور للوصول إلى هذه الفعالية.',
    ...
    'step1' => [
        ...
        'sold_out_error' => 'نفذت جميع التذاكر لهذا التاريخ. الرجاء اختيار تاريخ آخر.',
    ],
