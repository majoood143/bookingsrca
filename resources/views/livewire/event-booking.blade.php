                    ...
                    @elseif ($activeGateway === 'ccavenue')
                        <div
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-bold text-gray-900 text-lg">
                                        {{ __('event_booking.step6.ccavenue_title') }}</p>
                                    <p class="text-sm text-gray-500">{{ __('event_booking.step6.ccavenue_subtitle') }}
                                    </p>
                                </div>
                                <div class="ml-auto">
                                    <span
                            ...
                            <p class="mt-4 text-sm text-teal-700 bg-teal-100 rounded-lg px-3 py-2">
                                {{ __('event_booking.step6.ccavenue_redirect_note') }}
                            </p>
                        </div>
                        ...
                        @elseif ($activeGateway === 'ccavenue')
                            <button type="button" wire:click="submitBooking"
                                ...
                                <span wire:loading wire:target="submitBooking" class="inline-flex items-center gap-2">
                                    ...
                                    {{ __('event_booking.step6.redirecting_ccavenue') }}
                                </span>
                            </button>
                        @else
                            <button type="button" wire:click="submitBooking"
                        ...
                        <div class="p-5 space-y-4 text-sm">
                            ...
                            @elseif ($activeGateway === 'ccavenue')
                                <div class="pt-2 text-center text-xs text-gray-400">
                                    ...
                                    {{ __('event_booking.step6.secured_by_ccavenue') }}
                                </div>
                            @endif
