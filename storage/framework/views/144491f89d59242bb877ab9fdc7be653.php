...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.loading-indicator','data' => ['wire:loading' => true,'wire:target' => 'previousPage,gotoPage,nextPage','class' => 'ml-3 h-5 w-5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:loading' => true,'wire:target' => 'previousPage,gotoPage,nextPage','class' => 'ml-3 h-5 w-5']); ?>
...
<?php endif; ?><?php /**PATH C:\Apache24\htdocs\bookings\storage\framework\views/e18ac7e535bf5fa61fe7b4cdf3acb87f.blade.php ENDPATH**/ ?>