...
<div
    ...
    <?php if($signage->background_image_path): ?>
        style="background-image:url('<?php echo e(asset('storage/' . $signage->background_image_path)); ?>')"
    <?php else: ?>
...
>
    ...
    <div
        class="contents"
        data-next-trip-starts-at="<?php echo e($nextTrip['starts_at'] ?? ''); ?>"
        x-data="{
            lang: '<?php echo e($initialLang); ?>',
            switchSeconds: <?php echo e($switchSeconds); ?>,
            clockTime: '',
            clockDate: '',
            countdownText: '--:--',
            _tickTimer: null,
    ...
    >
        ...
        <div class="relative z-10" x-show="lang === 'en'" x-cloak>
            <?php echo $__env->make('livewire.partials.signage-body', ['lang' => 'en', 'event' => $event, 'signage' => $signage, 'nextTrip' => $nextTrip, 'upcomingTrips' => $upcomingTrips], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>

        <div class="relative z-10" x-show="lang === 'ar'" x-cloak>
            <?php echo $__env->make('livewire.partials.signage-body', ['lang' => 'ar', 'event' => $event, 'signage' => $signage, 'nextTrip' => $nextTrip, 'upcomingTrips' => $upcomingTrips], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
</div>
<?php /**PATH /Users/majidalhajri/Downloads/booking/bookingrca/bookingsrca/resources/views/livewire/event-signage-dashboard.blade.php ENDPATH**/ ?>