...
<head>
    <meta charset="UTF-8">
    <title>Premium Booking - <?php echo e($booking->booking_reference); ?></title>
    <style>
        @page { margin: 0; }
...
<body>
    ...
    <div class="hero-header">
        ...
        <div class="hero-content">
            ...
            <div class="hero-subtitle"><?php echo e($booking->event->getTranslation('title', 'en')); ?></div>
            <div class="booking-badge"><?php echo e($booking->booking_reference); ?></div>
        </div>
    </div>

    <div class="main-content">
        <!-- Mega Status Card -->
        <div class="status-card status-<?php echo e($booking->status); ?>">
            <div class="status-mega-badge">
                <?php echo e(ucfirst(str_replace('_', ' ', $booking->status))); ?>

            </div>
            <div class="status-date">
                Booked on <?php echo e($booking->created_at->format('F j, Y \a\t H:i')); ?>
        ...
        <div class="card">
            ...
            <div class="info-modern">
                <div class="info-item">
                    ...
                    <div class="info-val"><?php echo e($booking->event->getTranslation('title', 'en')); ?></div>
                </div>
                <div class="info-item">
                ...
                <div class="info-item">
                    ...
                    <div class="info-val">📍 <?php echo e($booking->event->getTranslation('location', 'en')); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-icon">👥</div>
                <h2 class="card-title">Attendees (<?php echo e($booking->attendees->count()); ?>)</h2>
            </div>
            ...
            <table class="premium-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="attendee-avatar"><?php echo e($index + 1); ?></div>
                        </td>
                        <td style="font-weight: 600;"><?php echo e($attendee->getFullName()); ?></td>
                        <td style="color: #6b7280;"><?php echo e($attendee->email); ?></td>
                        <td><span class="ticket-chip"><?php echo e($attendee->ticket_number); ?></span></td>
        ...
        <div class="card">
            ...
            <div class="info-modern">
                ...
                <div class="info-item">
                    <div class="info-key"><?php echo e($service->getTranslation('name', 'en')); ?></div>
                    <div class="info-val" style="color: #059669; font-weight: 700;">
                        $<?php echo e(number_format($service->pivot->quantity * $service->pivot->price, 2)); ?>
        ...
        <div class="card">
            ...
            <div class="mega-price-box">
                <div class="price-line">
                    <div>Tickets (<?php echo e($booking->quantity); ?> × $<?php echo e(number_format($booking->ticket_price / $booking->quantity, 2)); ?>)</div>
                    <div style="font-weight: 600;">$<?php echo e(number_format($booking->ticket_price, 2)); ?></div>
                </div>
                ...
                <div class="price-line">
                    ...
                    <div style="font-weight: 600;">$<?php echo e(number_format($booking->services_price, 2)); ?></div>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <div class="price-total-mega">
                    <div>TOTAL PAID</div>
                    <div>$<?php echo e(number_format($booking->total_price, 2)); ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="premium-footer">
        <div class="footer-brand"><?php echo e(strtoupper(config('app.name', 'EVENT SYSTEM'))); ?></div>
...
</html><?php /**PATH /Users/majidalhajri/Downloads/booking/bookingrca/bookingsrca/resources/views/bookings/summary-pdf-premium.blade.php ENDPATH**/ ?>