...
<body>
    ...
    <div class="section">
        <div class="section-title"><?php echo e(__('event_insights.sections.summary', [], $locale)); ?></div>
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-label"><?php echo e(__('event_insights.stats.confirmed', [], $locale)); ?></div>
            </div>
            <div class="stat-card">
                <div class="stat-value"><?php echo e($pendingCount); ?></div>
                <div class="stat-label"><?php echo e(__('event_insights.stats.pending', [], $locale)); ?></div>
            </div>
            <div class="stat-card">
                <div class="stat-value"><?php echo e($cancelledCount); ?></div>
                <div class="stat-label"><?php echo e(__('event_insights.stats.cancelled', [], $locale)); ?></div>
            </div>
            <div class="stat-card">
                <div class="stat-value"><?php echo e($checkedInCount); ?></div>
                <div class="stat-label"><?php echo e(__('event_insights.stats.checked_in', [], $locale)); ?></div>
            </div>
        </div>
        <div class="stats-grid">
            <div class="stat-card">
            ...
            <div class="stat-card">
                <div class="stat-value"><?php echo e($capacityPct !== null ? number_format($capacityPct, 1) . '%' : __('event_insights.stats.unlimited', [], $locale)); ?></div>
                <div class="stat-label"><?php echo e(__('event_insights.stats.capacity', [], $locale)); ?></div>
            </div>
            <div class="stat-card">
                <div class="stat-value"><?php echo $fmt($totalDiscount); ?></div>
                <div class="stat-label"><?php echo e(__('event_insights.stats.total_discount', [], $locale)); ?></div>
            </div>
        </div>
    </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalBookings === 0): ?>
        <p><?php echo e(__('event_insights.no_data', [], $locale)); ?></p>
    <?php else: ?>

    <div class="section">
        <div class="section-title"><?php echo e(__('event_insights.sections.trend', [], $locale)); ?></div>
        <div class="chart-wrap"><canvas id="trendChart"></canvas></div>
    </div>

    <div class="section page-break">
        <div class="section-title"><?php echo e(__('event_insights.sections.by_ticket', [], $locale)); ?></div>
...
<script>
    ...
    new Chart(document.getElementById('trendChart'), {
        ...
        data: {
            ...
            datasets: [{
                label: '<?php echo e(__('reports.columns.bookings', [], $locale)); ?>',
...
<?php /**PATH /Users/majidalhajri/Downloads/booking/bookingrca/bookingsrca/resources/views/reports/event-insights-pdf.blade.php ENDPATH**/ ?>