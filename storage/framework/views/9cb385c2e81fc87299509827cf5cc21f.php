...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($primaryAttendee && $primaryAttendee->getQrCodeUrl()): ?>
                <div class="qr-code">
                    <h3><?php echo e(__('Your Ticket QR Code')); ?></h3>
                    <img src="<?php echo e($primaryAttendee->getQrCodeUrl()); ?>" alt="QR Code" style="max-width: 200px;">
