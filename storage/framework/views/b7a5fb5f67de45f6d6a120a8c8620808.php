...
<head>
    ...
    <title><?php echo e(__('event_booking.email.tickets_heading')); ?></title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1><?php echo e(__('event_booking.email.tickets_heading')); ?></h1>
        <p><?php echo e($booking->event->getTranslation('title', $locale)); ?></p>
    </div>

    <div class="content">
        <h2><?php echo e(__('event_booking.email.ticket_hello', ['name' => $primary?->first_name])); ?></h2>

        <p><?php echo e(__('event_booking.email.tickets_intro', ['count' => $attendees->count()])); ?></p>

        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
            <tr>
                <td class="label" style="font-weight: bold; width: 40%; color: #555;"><?php echo e(__('event_booking.email.event')); ?>:</td>
                <td><?php echo e($booking->event->getTranslation('title', $locale)); ?></td>
            </tr>
            <tr>
                <td class="label" style="font-weight: bold; color: #555;"><?php echo e(__('event_booking.email.date')); ?>:</td>
                <td><?php echo e($booking->event_date->format('l, F j, Y')); ?></td>
            </tr>
            <tr>
                <td class="label" style="font-weight: bold; color: #555;"><?php echo e(__('event_booking.email.time')); ?>:</td>
                <td><?php echo e($booking->timeSlot->getTimeRange()); ?></td>
            </tr>
            <tr>
                <td class="label" style="font-weight: bold; color: #555;"><?php echo e(__('event_booking.email.location')); ?>:</td>
        ...
        <h3><?php echo e(__('event_booking.email.tickets_list_heading')); ?></h3>
...
<?php /**PATH /Users/majidalhajri/Downloads/booking/bookingrca/bookingsrca/resources/views/emails/all-tickets.blade.php ENDPATH**/ ?>