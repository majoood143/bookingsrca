    ...
    <div class="bg-gradient-to-r from-brand to-brand-hover text-white">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
            ...
            <div class="mt-3 flex flex-wrap gap-x-5 gap-y-1 text-sm text-blue-200">
                ...
                <span>📅 <?php echo e($event->start_date->format('M d')); ?> – <?php echo e($event->end_date->format('M d, Y')); ?></span>
    ...
    <div class="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-20">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 py-4">
            <div class="flex items-center">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [1 => __('event_booking.steps.date'), 2 => __('event_booking.steps.time'), 3 => __('event_booking.steps.tickets'), 4 => __('event_booking.steps.extras'), 5 => __('event_booking.steps.details'), 6 => __('event_booking.steps.payment')]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $num => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center <?php echo e($num < 6 ? 'flex-1' : ''); ?>">
                        <div class="flex items-center gap-2 shrink-0">
                            <div class="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-colors
                                <?php echo e($step > $num  ? 'bg-green-500 text-white'
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($num < 6): ?>
                            <div class="flex-1 h-0.5 mx-2 sm:mx-3 transition-colors
                                <?php echo e($step > $num ? 'bg-green-400' : 'bg-gray-200'); ?>"></div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step === 2): ?>
            <div>
                ...
                <p class="text-gray-500 mb-6">
                    ...
                    <strong class="text-gray-700"><?php echo e(\Carbon\Carbon::parse($selectedDate)->format('l, F j, Y')); ?></strong>
                </p>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4" wire:loading.class="opacity-50 pointer-events-none">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $timeSlots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <button
                            wire:click="<?php echo e($slotAvailable ? 'selectSlot(' . $slot->id . ')' : ''); ?>"
                            ...
                            <div class="flex justify-between items-start mb-3">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$slotAvailable): ?>
                                    <span class="text-xs bg-red-100 text-red-600 px-2.5 py-1 rounded-full font-semibold"><?php echo e(__('event_booking.step2.full')); ?></span>
                                <?php elseif($remaining <= 5): ?>
                                    <span class="text-xs bg-amber-100 text-amber-700 px-2.5 py-1 rounded-full font-semibold"><?php echo e(__('event_booking.step2.almost_full')); ?></span>
                                <?php else: ?>
                                    <span class="text-xs bg-green-100 text-green-700 px-2.5 py-1 rounded-full font-semibold"><?php echo e(__('event_booking.step2.available')); ?></span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        ...
                        <div class="p-5 border-2 rounded-2xl transition-all duration-150
                            ...
                            <div class="flex flex-wrap items-center gap-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center gap-2 flex-wrap">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$typeAvailable): ?>
                                            <span class="text-xs bg-red-100 text-red-600 px-2 py-0.5 rounded-full font-medium"><?php echo e(__('event_booking.step3.sold_out')); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                    ...
                                    <p class="text-xs text-gray-400 mt-1">
                                        <?php echo e($ticketType->getRemainingQuantity()); ?> <?php echo e(__('event_booking.step3.tickets_available')); ?>
                                ...
                                <div class="text-right shrink-0">
                                    <div class="text-2xl font-black text-gray-900">OMR<?php echo e(number_format($ticketType->price, 3)); ?></div>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($typeAvailable): ?>
                                    <div class="flex items-center gap-3 shrink-0">
                                        <button type="button"
                                            wire:click="decrementQuantity(<?php echo e($ticketType->id); ?>)"
                                        ...
                                        <span class="text-2xl font-black text-gray-900 w-8 text-center tabular-nums"><?php echo e($qty); ?></span>
                                        <button type="button"
                                            wire:click="incrementQuantity(<?php echo e($ticketType->id); ?>)"
                                            <?php echo e(($ticketQuantities[$ticketType->id] ?? 0) >= $maxTickets || array_sum($ticketQuantities) >= $maxTickets ? 'disabled' : ''); ?>

                                            class="w-10 h-10 rounded-full border-2 flex items-center justify-center text-xl font-bold transition-colors
                                                <?php echo e(($ticketQuantities[$ticketType->id] ?? 0) >= $maxTickets || array_sum($ticketQuantities) >= $maxTickets ? 'border-gray-200 text-gray-300 cursor-not-allowed' : 'border-gray-300 text-gray-600 hover:border-blue-500 hover:text-blue-600'); ?>">
                                            +
                                        </button>
                                    </div>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($qty > 0): ?>
                                        <div class="text-right shrink-0 min-w-[80px]">
                                            <div class="text-sm font-semibold text-blue-700">
                                                OMR<?php echo e(number_format($ticketType->price * $qty, 3)); ?>

                                            </div>
                                            <div class="text-xs text-gray-400"><?php echo e(__('event_booking.step3.subtotal')); ?></div>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalQty > 0): ?>
                    <div class="mt-6 p-4 sm:p-5 bg-gray-900 text-white rounded-2xl flex justify-between items-center">
                        <div>
                            ...
                            <span class="ml-2 text-xs text-gray-500"><?php echo e(__('event_booking.step3.n_tickets', ['n' => $totalQty])); ?></span>
                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="space-y-3">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $extraServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php $isSelected = in_array($service->id, $ticketTypeServices[$ticketType->id] ?? []); ?>
                                            <div wire:click="toggleService(<?php echo e($ticketType->id); ?>, <?php echo e($service->id); ?>)"
                                                ...
                                                <div class="flex items-start gap-4">
                                                    ...
                                                    <div class="mt-0.5 w-5 h-5 rounded border-2 flex items-center justify-center shrink-0 transition-colors
                                                        <?php echo e($isSelected ? 'border-blue-500 bg-blue-500' : 'border-gray-300 bg-white'); ?>">
                                                    ...
                                                    <div class="flex-1 min-w-0">
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($service->quantity_available): ?>
                                                            <p class="text-xs text-gray-400 mt-1"><?php echo e($service->getRemainingQuantity()); ?> <?php echo e(__('event_booking.step4.available')); ?></p>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    </div>
                                                    <div class="shrink-0 text-right">
                                                        <div class="text-xl font-bold text-gray-900">+OMR <?php echo e(number_format($service->price, 3)); ?></div>
                                                        <div class="text-xs text-gray-400"><?php echo e(__('event_booking.step4.per_ticket')); ?></div>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isSelected): ?>
                                                            <div class="text-xs text-blue-600 font-medium mt-0.5">
                                                                = OMR <?php echo e(number_format($service->price * $qty, 3)); ?>
                        ...
                        <div class="mb-6 p-4 bg-indigo-50 border border-indigo-200 rounded-xl flex items-start gap-3">
                            ...
                            <label for="copyContactToAll" class="text-sm text-indigo-800 cursor-pointer leading-snug">
                                ...
                                <span class="block text-indigo-500 text-xs mt-0.5">
                                    <?php echo e(__('event_booking.step5.email_label')); ?><?php echo e($showPhone ? ' & ' . __('event_booking.step5.phone_label') : ''); ?> <?php echo e(__('event_booking.step5.copy_contact_hint')); ?>
                                ...
                                <div class="px-5 py-3 flex items-center gap-3 rounded-t-2xl
                                    ...
                                    <span class="font-semibold text-gray-800">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($i === 0): ?>
                                            <span class="text-xs text-blue-500 font-normal ml-1">(<?php echo e(__('event_booking.step5.primary')); ?>)</span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </span>
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div>
                                            <label class="block text-sm font-semibold text-gray-700 mb-1.5">
                                                <?php echo e(__('event_booking.step5.first_name')); ?> <span class="text-red-500">*</span>
                                            </label>
                                            <input type="text"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        ...
                                        <div>
                                            <label class="block text-sm font-semibold text-gray-700 mb-1.5">
                                                <?php echo e(__('event_booking.step5.last_name')); ?> <span class="text-red-500">*</span>
                                            </label>
                                            <input type="text"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showEmail): ?>
                                        <div>
                                            <label class="block text-sm font-semibold text-gray-700 mb-1.5">
                                                <?php echo e(__('event_booking.step5.email_address')); ?> <span class="text-red-500">*</span>
                                            </label>
                                            <input type="email"
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($i === 0): ?>
                                                <p class="text-xs text-gray-400 mt-1.5"><?php echo e(__('event_booking.step5.email_hint')); ?></p>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showPhone): ?>
                                        <div>
                                            <label class="block text-sm font-semibold text-gray-700 mb-1.5"><?php echo e(__('event_booking.step5.phone_number')); ?></label>
                                            <input type="tel"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showDateOfBirth || $showGender || $showNationality): ?>
                                        <?php $optCount = collect([$showDateOfBirth, $showGender, $showNationality])->filter()->count(); ?>
                                        <div class="grid grid-cols-1 sm:grid-cols-<?php echo e($optCount); ?> gap-4">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showDateOfBirth): ?>
                                                <div>
                                                    <label class="block text-sm font-semibold text-gray-700 mb-1.5"><?php echo e(__('event_booking.step5.date_of_birth')); ?></label>
                                                    <input type="date"
                                                        wire:model="attendees.<?php echo e($i); ?>.date_of_birth"
                                                        min="<?php echo e($minBirthDate); ?>"
                                                        max="<?php echo e($maxBirthDate); ?>"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showGender): ?>
                                                <div>
                                                    <label class="block text-sm font-semibold text-gray-700 mb-1.5"><?php echo e(__('event_booking.step5.gender')); ?></label>
                                                    <select wire:model="attendees.<?php echo e($i); ?>.gender"
                                                        ...
                                                        <option value=""><?php echo e(__('event_booking.step5.select_gender')); ?></option>
                                                        <option value="male"><?php echo e(__('event_booking.step5.male')); ?></option>
                                                        <option value="female"><?php echo e(__('event_booking.step5.female')); ?></option>
                                                    </select>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showNationality): ?>
                                                <div class="relative"
                                                    ...
                                                    <label class="block text-sm font-semibold text-gray-700 mb-1.5"><?php echo e(__('event_booking.step5.nationality')); ?></label>
                                                    <input type="text"
                                                        x-model="search"
                                                        @focus="open = true"
                                                        @input="open = true"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($termsEn || $termsAr): ?>
                            <div class="rounded-xl border border-gray-200 overflow-hidden">
                                <div class="bg-gray-50 px-4 py-3 border-b border-gray-200">
                                    <h4 class="font-semibold text-gray-800 text-sm"><?php echo e(__('event_booking.step5.terms_heading')); ?></h4>
                                </div>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <label for="agreedToTerms" class="text-sm text-gray-700 cursor-pointer leading-snug">
                                    ...
                                    <span class="font-semibold text-gray-900"><?php echo e(__('event_booking.step5.terms_heading')); ?></span>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden lg:sticky lg:top-24">
                        ...
                        <div class="p-5 space-y-4 text-sm">
                            ...
                            <div>
                                <p class="text-xs text-gray-400 uppercase tracking-wider font-bold mb-0.5"><?php echo e(__('event_booking.summary.event')); ?></p>
                                <p class="font-semibold text-gray-900 leading-tight"><?php echo e($event->getTranslation('title', app()->getLocale())); ?></p>
                            </div>

                            <div class="pt-3 border-t border-gray-100 grid grid-cols-2 gap-3">
                                <div>
                                    <p class="text-xs text-gray-400 uppercase tracking-wider font-bold mb-0.5"><?php echo e(__('event_booking.summary.date')); ?></p>
                                    <p class="font-medium text-gray-800"><?php echo e(\Carbon\Carbon::parse($selectedDate)->format('M d, Y')); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-400 uppercase tracking-wider font-bold mb-0.5"><?php echo e(__('event_booking.summary.time')); ?></p>
                                    <p class="font-medium text-gray-800"><?php echo e($timeSlots->find($selectedSlot)?->getTimeRange()); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="pt-3 border-t border-gray-100">
                                <p class="text-xs text-gray-400 uppercase tracking-wider font-bold mb-2"><?php echo e(__('event_booking.summary.tickets')); ?></p>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $ticketTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticketType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $qty = $ticketQuantities[$ticketType->id] ?? 0; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($qty > 0): ?>
                                        <div class="flex justify-between items-center text-gray-700 mb-1">
                                            <span class="truncate pr-2"><?php echo e($ticketType->getTranslation('name', app()->getLocale())); ?></span>
                                            <span class="shrink-0 text-gray-400 text-xs">× <?php echo e($qty); ?></span>
                                        </div>
                                        <div class="flex justify-between text-gray-500 text-xs mb-2">
                                            <span>OMR<?php echo e(number_format($ticketType->price, 3)); ?> × <?php echo e($qty); ?></span>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($attendees)): ?>
                                <div class="pt-3 border-t border-gray-100">
                                    <p class="text-xs text-gray-400 uppercase tracking-wider font-bold mb-2"><?php echo e(__('event_booking.summary.attendees')); ?></p>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $attendees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php $attendeeTicketType = $ticketTypes->find($attendee['ticket_type_id'] ?? null); ?>
                                        <div class="flex justify-between items-center text-gray-700 mb-1">
                                            <span class="truncate pr-2"><?php echo e(trim(($attendee['first_name'] ?? '') . ' ' . ($attendee['last_name'] ?? '')) ?: '—'); ?></span>
                                            <span class="shrink-0 text-gray-400 text-xs truncate max-w-[40%]"><?php echo e($attendeeTicketType?->getTranslation('name', app()->getLocale())); ?></span>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasServices): ?>
                                <div class="pt-3 border-t border-gray-100">
                                    <p class="text-xs text-gray-400 uppercase tracking-wider font-bold mb-2"><?php echo e(__('event_booking.summary.extra_services')); ?></p>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $ticketTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticketType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $qty        = $ticketQuantities[$ticketType->id] ?? 0;
                                            $serviceIds = $ticketTypeServices[$ticketType->id] ?? [];
                                        ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($qty > 0 && !empty($serviceIds)): ?>
                                            <p class="text-xs text-gray-400 mb-1"><?php echo e($ticketType->getTranslation('name', app()->getLocale())); ?></p>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $serviceIds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serviceId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php $svc = $extraServices->find($serviceId); ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($svc): ?>
                                                    <div class="flex justify-between text-gray-600 text-xs mb-1">
                                                        <span class="truncate pr-2"><?php echo e($svc->getTranslation('name', app()->getLocale())); ?></span>
                                                        <span class="shrink-0">OMR<?php echo e(number_format($svc->price * $qty, 3)); ?></span>
                                                    </div>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="pt-3 border-t-2 border-gray-200 flex justify-between items-baseline">
                                <span class="font-bold text-gray-900 text-base"><?php echo e(__('event_booking.summary.total')); ?></span>
                                <span class="font-black text-2xl text-blue-600">OMR<?php echo e(number_format($totalPrice, 3)); ?></span>
                            </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeGateway === 'thawani'): ?>
                        <div class="p-6 border-2 border-blue-500 bg-blue-50 rounded-2xl shadow-md shadow-blue-100 mb-6">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-bold text-gray-900 text-lg"><?php echo e(__('event_booking.step6.thawani_title')); ?></p>
                                    <p class="text-sm text-gray-500"><?php echo e(__('event_booking.step6.thawani_subtitle')); ?></p>
                                </div>
                                <div class="ml-auto">
                    ...
                    <?php elseif($activeGateway === 'nbo'): ?>
                        <div class="p-6 border-2 border-indigo-500 bg-indigo-50 rounded-2xl shadow-md shadow-indigo-100 mb-6">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-bold text-gray-900 text-lg"><?php echo e(__('event_booking.step6.nbo_title')); ?></p>
                    ...
                    <?php elseif($activeGateway === 'cash'): ?>
                        <div class="p-6 border-2 border-amber-400 bg-amber-50 rounded-2xl mb-6">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-bold text-gray-900 text-lg"><?php echo e(__('event_booking.step6.pay_at_door_title')); ?></p>
                                    <p class="text-sm text-gray-500"><?php echo e(__('event_booking.step6.pay_at_door_subtitle')); ?></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php else: ?>
                        ...
                        <div class="p-6 border-2 border-green-400 bg-green-50 rounded-2xl mb-6">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-bold text-gray-900 text-lg"><?php echo e(__('event_booking.step6.free_title')); ?></p>
                                    <p class="text-sm text-gray-500"><?php echo e(__('event_booking.step6.free_subtitle')); ?></p>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="p-5 space-y-4 text-sm">
                            ...
                            <div class="pt-3 border-t border-gray-100">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $ticketTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticketType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($qty > 0): ?>
                                        <div class="flex justify-between text-gray-600 text-xs mb-1">
                                            <span class="truncate pr-2"><?php echo e($ticketType->getTranslation('name', app()->getLocale())); ?> × <?php echo e($qty); ?></span>
                                            <span class="shrink-0">OMR<?php echo e(number_format($ticketType->price * $qty, 3)); ?></span>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
...
<?php /**PATH C:\Apache24\htdocs\bookings\resources\views\livewire\event-booking.blade.php ENDPATH**/ ?>